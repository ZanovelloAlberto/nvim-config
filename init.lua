...
-- io.popen("/usr/bin/foot", "r")
-- vim.keymap.set
-- vim.keymap.set('n', '<C-K>',"<Cmd>echo 'h8'<CR>")
-- vim.keymap.set('n', '<C-L>',"<Cmd>echo 'h8'<CR>")
-- vim.keymap.set('n', '<C-S-L>',[[<C-w>>]])--"<Cmd>echo 'funziona csl'<CR>")

-- lines added to exit terminal
...
-- vim.keymap.set('i', '<C-j', require('telescope.builtin').oldfiles, { desc = '[?] Find recently opened files' })
